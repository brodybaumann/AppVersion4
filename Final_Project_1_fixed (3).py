...
def _close_sidebar_on_mobile():
    """Inject JS to click the sidebar collapse button on mobile screens."""
    import streamlit.components.v1 as components
    components.html(
        """
        <script>
        // Only collapse on narrow screens (mobile)
...
def apply_theme():
    ...
    <style>
        ...
        section[data-testid="stSidebar"] span:not(.material-symbols-rounded) {{
            color: {C_TEXT} !important;
            font-family: {FONT} !important;
        }}
        /* Sidebar collapse button — keep Material Symbols so arrow glyph renders */
